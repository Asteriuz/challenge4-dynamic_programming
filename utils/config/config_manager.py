...
class ConfigManager:
    ...
    def _load_config(self) -> Config:
        ...
        try:
            ...
            return Config(
                ...
                fuzzy_distance=data.get("fuzzy_distance", 2),
            )
    ...
    def save_config(self) -> None:
        ...
        try:
            data = {
                ...
                "fuzzy_distance": self._config.fuzzy_distance,
            }
    ...
    def undo_last_config_change(self) -> bool:
        ...
        self._config.fuzzy_distance = previous_state["fuzzy_distance"]
